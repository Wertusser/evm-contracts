...
contract DeployScript is Script {
  ...
  function deployForPool(
    ...
    vault = address(deployed.computeERC4626Address_(poolId, stakingId));
  ...
  function run() public payable returns (StargateVaultFactory deployed) {
    ...
    IStargateLPStaking stakingMock = new StargateLPStakingMock(
          // USDC-LP
          ERC20Mock(address(0xA02e1F8c4546367763FA78fc077ba89291D4bc6C)),
          // DAI
          ERC20Mock(address(0xBa8DCeD3512925e52FE67b1b5329187589072A55))
        );
