...
import { UniV3Swapper, IUniswapV3Factory, IUniswapV3Router } from "../../src/swappers/UniV3Swapper.sol";
...
contract DeployScript is Script {
  function run() public payable returns (UniV3Swapper deployed) {
    ...
    IUniswapV3Factory factory =
      IUniswapV3Factory(address(0x0));
    IUniswapV3Router router =
      IUniswapV3Router(address(0x31F63A33141fFee63D4B26755430a390ACdD8a4d));
    ...
    console2.log("preview path:", deployed.previewPath(STG_AMOUNT, path, fee));
