...
import {SenderCreator} from "../utils/SenderCreator.sol";
import {ValidationHelper} from "../utils/ValidationHelper.sol";
...
contract EntryPoint is IEntryPoint, StakeManager {
        ...
        override
    {
        ...
        ValidationHelper.ValidationData memory data =
            ValidationHelper.intersectTimeRange(validationData, paymasterValidationData);
        ...
        returns (address aggregator, bool outOfTimeRange)
    {
        ...
        ValidationHelper.ValidationData memory data = ValidationHelper.parseValidationData(validationData);
